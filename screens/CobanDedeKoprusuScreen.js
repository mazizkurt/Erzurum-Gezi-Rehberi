    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{fontWeight:'bold',fontFamily:'space-mono',textAlign:'center',color:'grey'}}>Üstünden geçtiğin köprüleri yıkma, bir gün geri dönmek zorunda kalabilirsin.</Text>
          </View>
        </View>
              
       <ScrollView >
           <View style={{flex:1,marginTop:200,width:'98%',justifyContent:'center',alignItems:'center'}}>
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray'}}>Çoban Dede Köprüsü</Text>
        <Text></Text>
        <Text style={{fontFamily:'space-mono',fontSize:12,color:'#b5b5b5',textAlign:'center'}}>
        Çobandede Köprüsü; Tarihi İpek Yolu güzergâhında bulunan köprü, İlhanlı Hükümdarı Gazan Han'ın (1295-1304) Veziri Salduzlu Emir Çoban Noyin tarafından 1298 yılında yaptırılmıştır. Köprünün yapı formu ve baş kısmındaki bezemeler Selçuklu ve İlhanlı mimari üslubunu yansıtır. Karga Pazarı ve Aras nehirlerinin birleştiği yerde bulunan köprü 128 m. uzunluğunda, 8,5 m. genişliğindedir. Köprünün en büyük kemer açıklığı 13 m., en yüksek noktası da 30 m. dir. Yedi yuvarlak kemerli gözden oluşan köprünün ilk gözü son yıllarda yapılan onarım sırasında kapatılmıştır. Köprünün kemerleri siyah, kırmızı ve gri renkli kesme taşlardan yapılmıştır. Köprü ayaklarının altına ardıç ağaçları döşenmiştir. Böylece köprünün batması engellenmiştir. Köprü ağırlığını hafifletmek için de tampon duvarları arasında boşluk bırakılmıştır. 1727-1872 ve 1948 yıllarında onarım geçiren Çobandede Köprüsü, son olarak 2011 yılında restore edilmiştir. 
        </Text>
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.bilginvarmi.com/wp-content/uploads/2015/11/%C3%87obandede-K%C3%B6pr%C3%BCs%C3%BC-Manzaras%C4%B1.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.kulturportali.gov.tr/Common/GetFoto.aspx?f=MjAxNjEyMTQxMDQ1MDcwMDJfRVJaVVJVTSBLT1BSVUtPWSBJTENFU0kgQ09CQU5ERURFIEtPUFJVU1UgIEZvdG9ncmFmIE11cmF0IE9DQUwgMDgxMS5KUEc%3D&d=U2VoaXJSZWhiZXJpXFxHZXppbGVjZWtZZXJc&s=bGFyZ2U%3D'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
/>
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Çoban Dede Köprüsü</Text>
