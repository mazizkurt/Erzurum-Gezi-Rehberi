...
export default class ErzurumkongresiScreen extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{fontWeight:'bold',fontFamily:'space-mono',textAlign:'center',color:'grey'}}> "Tarih bu kongremizi şüphesiz ender ve büyük bir eser olarak kaydedecektir."</Text>
          </View>
        </View>
              
       <ScrollView >
           <View style={{flex:1,marginTop:200,width:'98%',justifyContent:'center',alignItems:'center'}}>
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray',textAlign:'center'}}>Erzurum Kongresi ve Kongre Binası</Text>
        <Text></Text>
...
Erzurum Kongresinin bir önemi de Batı Anadolu'da Yunan kuvvetlerine karşı mücadele eden Kuva-yi Milliye üzerinde büyük moral etkisi yaptı.
        ...
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'http://c11.incisozluk.com.tr/res/incisozluk/11001/8/476648_ofce3.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://iasbh.tmgrup.com.tr/07837b/650/344/0/20/600/338?u=http://i.sabah.com.tr/sbh/2017/01/19/erzurum-kongresinin-onemi-nedir-hangi-kararlar-alinmistir-1484811037771.jpg'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
          ...
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://turkiye.net/wp-content/uploads/2015/03/ermeni-lisesi2.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
            <PublisherBanner
...
Erzurum Kongresinin bir önemi de Batı Anadolu'da Yunan kuvvetlerine karşı mücadele eden Kuva-yi Milliye üzerinde büyük moral etkisi yaptı.
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Yaşa! Mustafa Kemal Paşa</Text>
            <Image source={{uri:'https://img.epttavm.com/pimages/592/033/610/59b27caa4319e.jpg'}} style={{width:100,height:50,marginTop:Platform.OS === 'ios' ? 5 : -5}} />
