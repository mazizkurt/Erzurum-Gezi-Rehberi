...
export default class MuzelerScreen extends React.Component {
...
Müzelerinde yatar
       ...
       <ScrollView >
        ...
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray',textAlign:'center'}}>Atatürk Evi ve Müzesi</Text>
        <Text></Text>
        <Text style={{fontFamily:'space-mono',fontSize:12,color:'#b5b5b5',textAlign:'center'}}>
        Konak, Erzurum eşrafından biri tarafından 19. yüzyılın sonlarında yaptırılmıştır. Mustafa Kemal ve arkadaşları Millî Mücadele'nin en önemli adımlarından birini gerçekleştirmek üzere Erzurum’a geldiklerinde bu konağa yerleşmişlerdir. 9 Temmuz 1919'dan 29 Ağustos 1919'a kadar 52 gün süren dönemde Erzurum Kongresi çalışmalarının önemli bir kısmını bu konakta sürdürmüşlerdir.

1984 yılında Kültür Bakanlığı'na devredilen konak, devir işlemiyle birlikte Atatürk Evi Müzesi olarak ziyarete açılmıştır. Kareye yakın bir alana oturan yapı, bodrum üzeri iki katlıdır. Girişi, yuvarlak kemerli bir kapı ile sağlanır. Kaide ve temellerde kesme taşın, diğer kısımlarda ahşap kirişlerle moloz taşın kullanıldığı yapıda 1890'lı yılların üslup özellikleri dikkat çekmektedir.

Müze yaz döneminde 08.00-19.00, kış döneminde ise 08.00-17.00 saatleri arasında hizmet vermekte olup haftanın her günü açıktır. Müze dini bayramların birinci günü saat 13.00’e kadar kapalıdır. Girişler ücretsizdir.       
        </Text>
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.kulturportali.gov.tr/Common/GetFoto.aspx?f=MjAxNjEyMTQxMDE5Mzk5MTZfRVJaVVJVTSBBdGF0dXJrIEV2aSBNdXplc2kgIDAwMzQuanBn&d=U2VoaXJSZWhiZXJpXFxHZXppbGVjZWtZZXJc&s=bGFyZ2U%3d'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.kulturportali.gov.tr/Common/GetFoto.aspx?f=MjAxNjEyMTQxMDE5NTUwMTZfRVJaVVJVTSBBdGF0dXJrIEV2aSBNdXplc2kgRm90b2dyYWYuanBn&d=U2VoaXJSZWhiZXJpXFxHZXppbGVjZWtZZXJc&s=bGFyZ2U%3d'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
Müze yaz döneminde 08.00-19.00, kış döneminde ise 08.00-17.00 saatleri arasında hizmet vermekte olup haftanın her günü açıktır. Müze dini bayramların birinci günü saat 13.00’e kadar kapalıdır. Girişler ücretsizdir.
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Atatürk Evi</Text>
