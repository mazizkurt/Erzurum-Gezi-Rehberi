...
export default class KayakMerkezleriScreen extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{fontWeight:'bold',fontFamily:'space-mono',textAlign:'center',color:'grey'}}>Doğa, Allah’ın yazdığı bir kitaptır.</Text>
       ...
       <ScrollView >
        ...
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray'}}>Kayak Merkezleri</Text>
        <Text></Text>
        <Text style={{fontFamily:'space-mono',fontSize:12,color:'#b5b5b5',textAlign:'center'}}>
              - Biatlon Kuzey Kombine {'\n'}
              - Serbest Stil Kayak {'\n'}
              - Kayaklı Koşu {'\n'}
              - Yamaç Paraşütü {'\n'}
              - Buz Hokeyi {'\n'}
        ...
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://i2.wp.com/www.gezecegiz.com/wp-content/uploads/2015/01/Erzurum_Pist_Haritasi.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Ski_Famille_-_Family_Ski_Holidays.jpg/1200px-Ski_Famille_-_Family_Ski_Holidays.jpg'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
/>
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Konaklı Kayak Merkezi</Text>
