...
export default class TashanScreen extends React.Component {
...
Oltu taşı tesbihi 
       ...
       <ScrollView >
        ...
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray',textAlign:'center'}}>Rüstem Paşa Kervansarayı (Taşhan)</Text>
        <Text></Text>
        ...
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.trthaber.com/dosyalar/images/ta%C5%9Fhan%20(1).jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'http://www.erzurum.bel.tr/img/CK/images/image025(2).jpg'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
Oltu taşı tesbihi 
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Taşhan</Text>
