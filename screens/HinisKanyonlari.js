...
export default class HinisKamyonlari extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{fontWeight:'bold',fontFamily:'space-mono',textAlign:'center',color:'grey'}}>Biz, tabiatı örnek alırsak asla yanılmayız. </Text>
       ...
       <ScrollView >
        ...
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray'}}>Hınıs Kanyonları</Text>
        <Text></Text>
        <Text style={{fontFamily:'space-mono',fontSize:12,color:'#b5b5b5',textAlign:'center'}}>
        Erzurum'un kültürel ve tarihi yerlerinden Hınıs Kanyonu
Bozulmamış Doğal Güzelliğiyle Hınıs Kanyonu Keşfedilmeyi Bekliyor
...
Hınıs Kanyonu 7 kilometre uzunluğa sahip. Kanyonun içinden geçen Hınıs Çayı etrafında bir çok kuş türü barınıyor. Erzurum'un en önemli doğal güzelliklerinden birisi olan kanyon özellikle bahar aylarında su seviyesinin yükselmesiyle eşsiz bir hal alıyor. Kışın kar ile sunduğu kış manzaraları yanında suyun yüksek olduğu dönemlerde rafting, dağcılık ve kanyon tutkunları için eşsiz bir güzellik sunuyor.
Ayrıca Hınıs kanyonunda 1734 yılında Muş Beylerinden Alaeddin Bey tarafından yapılmış Hınıs Ulu Cami/Dere Camii bulunmaktadır.
        ...
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'http://erzurumportali.com/upload/6/38/7JS15Z6X.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://fastly.4sqi.net/img/general/600x600/180567975_2Pp2940MKvUbsvqsPMr9AkJuwWWHBIPe-tFHbDp-yR4.jpg'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
Ayrıca Hınıs kanyonunda 1734 yılında Muş Beylerinden Alaeddin Bey tarafından yapılmış Hınıs Ulu Cami/Dere Camii bulunmaktadır.
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Hınıs Kanyonları</Text>
