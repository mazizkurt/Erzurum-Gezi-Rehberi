...
export default class KisTurizmScreen extends React.Component {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={{fontWeight:'bold',fontFamily:'space-mono',textAlign:'center',color:'grey'}}>Güzeldir bembeyaz, kar beyaz her şeyden arınmış gibi.
       ...
       <ScrollView >
        ...
        <Text style={{fontFamily:'baslik',fontSize:25,color:'gray'}}>Kış Turizmi</Text>
        <Text></Text>
        <Text style={{fontFamily:'space-mono',fontSize:12,color:'#b5b5b5',textAlign:'center'}}>
        Erzurum şehir merkezine sadece 10 dk uzaklıkta yer alan Palandöken, Türkiyede kayak sezonunun en uzun sürdüğü yer olma özelliğini taşımaktadır.
        Merkeze yakın oluşu ile de şehrin tarihi mekanlarını ve merkezini rahatça görme imkanı sunar. Doğu Anadolunun en eski yerleşim alanı olan Palandökende
        kayak otelleri olmak üzere birçok kayak tesisi bulunmaktadır. Ülkemiz kayak turizminin en önemli kollarından biri olan Palandöken Kayak Merkezi,
        yılın 6 Ayı boyunca karla örtülüdür. Toplamda 22 adet piste sahiptir ve bu pistlerin toplam uzunluğu 57 km kadar uzanmaktadır. 1993 yılında Kış Turizm Merkezi
        ilan edilen Palandöken Dağları günümüzde de kar kalitesi ve uzun pistleri ile Dünyanın en önemli kayak pistlerinden biridir. Dünyanın en uzun ve en dik pistleri 
        arasında yer alan Palandöken Alp disiplini ve Snowboard için son derece elverişlidir. Bunun yanında yamaç paraşütü, paintball gibi spor aktiviteleri için uygundur.
        ...
        <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://www.emlaklobisi.com/wp-content/uploads/Palandoken-Kayak.jpg'}}
          />
        </Lightbox>
        <View style={styles.reklam}>
         ...
         <Lightbox underlayColor="white">
          <Image
            ...
            shadowRadius: 2,}}
            resizeMode="contain"
            source={{uri: 'https://hepgezelim.com/wp-content/uploads/2018/08/Erzurum-Paland%C3%B6ken-Kayak-Merkezi-700x445.jpg'}}
          />
        </Lightbox>
            <View style={styles.reklam}>
            <PublisherBanner
...
/>
    ...
    <View style={{flexDirection:'row',marginTop:200}}>
      <View style={{flexDirection:'column',marginLeft:Platform.OS === 'ios' ? 0 : 0,marginTop:Platform.OS === 'ios' ? 0 : -15}}>
          ...
          <Text style={{fontSize:Platform.OS === 'ios' ? 20 : 15,fontFamily:'baslik1',color:'gray',marginTop:Platform.OS === 'ios' ? 5 : -5}} >Palandöken Kayak Merkezi</Text>
